var modelConfig = {
    title: '时段租充值记录', pkey: 'id', type: 'snow', orderBy: 'update_time Desc', namespace: "pay_recharge_time", table: 't_pay_inside_recharge',
    dp: JSON.stringify({park_id: 'parkIds'}), exjs: '${path.staticPath}/js/My97DatePicker/WdatePicker.js', isMultiTenant: true
};
var listPage = {
    ...
    otherFunctions: function () {
        return {
            onListPageReady: function () {
                ...
                $('#isContractF').combobox('setValue',0);
